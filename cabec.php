		...
		<header>
			<nav class="navbar navbar-expand-lg navbar-dark cor_barra">
			  	<div class="container-fluid">
					<a class="navbar-brand" href="./">TechRat</a>
				  		...
				  		<ul class="navbar-nav">
							...
							<li class="nav-item dropdown">
					  			...
					  			<ul class="dropdown-menu" aria-labelledby="navbarMenuLink">
									<li><a class="dropdown-item" href="#"><?php echo $lng['pessoa']; ?></a></li>
									<li><a class="dropdown-item" href="#"><?php echo $lng['produto']; ?></a></li>
					  			</ul>
							</li>
							...
							<li class="nav-item dropdown">
					  			...
					  			<ul class="dropdown-menu" aria-labelledby="navbarMenuLink">
									...
									<li><a class="dropdown-item" href="#"><?php echo $lng['balcao']; ?></a></li>
					  			</ul>
							</li>
							...
							?>
							<li class="nav-item">
							<form action="login.php" method="post"><button class="button3" href='login.php'>Login</button></form>	
							</li>
								</br>
							<li class="nav-item">
								<form action="cadastro.php" method="post"><button class="button3" href='cadastro.php'><?php echo $lng['cadastrar']; ?></button></form>
							</li>
							<?php } ?>
